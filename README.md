...
```bash
git clone https://github.com/Zel-hub7/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/Zel-hub7/hello-react-front-end/issues).
